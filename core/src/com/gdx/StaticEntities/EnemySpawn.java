...
public class EnemySpawn extends StaticEntity {
	...
	public EnemySpawn(Vector3 position, int id, boolean isActive, boolean isRenderable, boolean isDecalFacing, float initialSpawnTime, float delayedSpawnTime, Enemy enemy) {
