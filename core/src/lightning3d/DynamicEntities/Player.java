...
import lightning3d.Abilities.Blizzard;
import lightning3d.Abilities.PoisonCloud;
import lightning3d.Engine.Assets;
import lightning3d.Engine.DistanceTrackerMap;
import lightning3d.Engine.GameScreen;
import lightning3d.Engine.World;
import lightning3d.Engine.GameScreen.Mode;
...
public class Player extends DynamicEntity {
	...
	public void update(float delta, World world) {
		...
		if (newPos != oldPos && clipping && GameScreen.mode == Mode.Offline && world.getDistanceMap() != null) {
	...
	public void takeDamage(int damage) {
		this.health -= damage;
		world.setFilterEffect(new lightning3d.FilterEffects.RedFade());
	}
