...
public class Assets {
	...
	public static TiledMap mymap, mymap2, dungeon1, castle2, castle3, castle3Multi, rift;
	...
	public static void loadAssets() {
		...
		rift = new TmxMapLoader().load("rift.tmx");
	...
	public static void loadModels() {
	    ...
	    manager.load("tree.g3db", Model.class);
	    manager.load("bush.g3db", Model.class);
	    manager.load("grass.g3db", Model.class);
