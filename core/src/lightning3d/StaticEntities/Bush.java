...
public class Bush extends StaticEntity {
	public Bush(Vector3 position, int id, boolean isActive, boolean isRenderable, boolean isDecalFacing) {
		super(position, id, isActive, isRenderable, isDecalFacing, Assets.manager.get("bush.g3db", Model.class));
